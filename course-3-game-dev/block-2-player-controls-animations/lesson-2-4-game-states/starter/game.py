...
# Game states — only one is active at a time
START = "start"
PLAYING = "playing"
GAME_OVER = "game_over"

# TODO: Begin on the start screen
# state = START
state = PLAYING  # temporary — change to START when you wire the screens
...
speed = 250
score = 0.0
# Demo "timer": after this many seconds of playing, go to game over
play_time = 0.0
TIME_LIMIT = 15.0  # seconds — short so you can test game over quickly
...
while running:
    ...
    for event in pygame.event.get():
        ...
        # TODO: React to SPACE / RETURN depending on state
    ...
    if state == START:
        # TODO: Draw title + "Press SPACE to start"
        ...
        score = play_time * 10  # simple: points = time alive

        # TODO: When time runs out, switch to GAME_OVER
        ...
        # TODO: Draw "Game Over", final score, and restart hint
