...
export const ru: Dict = {
  ...
  auth: {
    signInTitle: "Вход",
    signInSubtitle: "С возвращением! Продолжай своё приключение в Python.",
    signInSubmit: "Войти",
    signingIn: "Входим…",
    signOut: "Выйти",
    signInCta: "Войти",
    ...
    errors: {
      ...
      email_not_verified: "Сначала подтверди почту.",
      too_many_attempts: "Слишком много попыток входа. Подожди минуту и попробуй снова.",
  ...
  blocks: {
    ...
    "course-3/block-2": { title: "Управление игроком и анимации", emoji: "🎛️" },
    "course-3/block-3": { title: "Физика и столкновения (финальный проект)", emoji: "⭐" },
  },
};
